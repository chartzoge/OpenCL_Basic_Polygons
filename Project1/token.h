...
enum Token {AT, COLOR, END,	HEIGHT,	ISOSCELES, OFFSET, PARALLELOGRAM_, RADIUS, REGULAR_POLYGON_, SCENE_, SIDES, TEXT, WIDTH, COMMA, 
...
static string tokenNames[] = {"at", "Color", "End", "Height", "Isosceles", "Offset", "Parallelogram", "Radius", "RegularPolygon", 
